...
The sales team currently follows X number of sales leads and closing Y product sales. The objective is to improve the efficiency of the sales team by reducing the number of sales leads pursued to X1 and increasing the number of actual products sold to Y1. Thus increasing the success rate.
